...
export default function EditTask() {
    ...
    const handleForm = (e) =>{
        ...
        const requestBody = {title, description, category, budget, openToOffers, location, imagePath}
        console.log(requestBody)
        axios.put(`/api/task/edit/${taskDetails._id}`, requestBody)
			.then((response) => {
    ...
    return (
        <div className='post-task-page'>
            ...
            <form onSubmit={handleForm} encType="multipart/form-data" className='task-form'>
                <h2 className='postTaskHeading'>Edit Task</h2>
                <div className='mb-3'>
                ...
                <button type='submit' disabled={submitDisabled} className="btn btn-primary taskPostBtn">Update Task</button>
            </form>
